            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="restaurante.php">Restaurante</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="shop-single-tierraroca.php" class="h3 text-decoration-none">Tierra Roca</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Horario Atencion</li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
