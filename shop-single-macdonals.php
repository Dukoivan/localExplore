        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="assets/img/macdonalds.png" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="assets/img/macdonalds.png" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="assets/img/macdonalds2.webp" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="assets/img/macdonals3.png" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Mcdonalds</h1>
                            <p class="h3 py-2">hamburguesa</p>
                            <p class="py-2">
                            ...
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Ubicacion:</h6>
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15905.358899291039!2d-74.112097!3d4.71092!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f84b275d6412f%3A0xc6294bf278c0e731!2sMcDonald&#39;s%20-%20Portal%2080!5e0!3m2!1ses!2sco!4v1724362701798!5m2!1ses!2sco" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </ul>

                            <h6>Descripcion:</h6>
                            <p>hambruguesa ricolino</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>carne :</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Asada</strong></p>
                                </li>
                            </ul>
